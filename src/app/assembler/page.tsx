...
export default function AssemblerPage() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `funnel-page-${selectedTemplateId}.html`;
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex justify-between mb-2">
              <h3 className="font-bold text-gray-900">2. Paste Text Data</h3>
              <span className="text-xs text-gray-500">From Text Factory</span>
            </div>
            <textarea
              className="w-full border p-3 rounded h-40 font-mono text-xs"
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex justify-between mb-2">
              <h3 className="font-bold text-gray-900">3. Paste Image Data</h3>
              <span className="text-xs text-gray-500">From Image Studio</span>
            </div>
            <textarea
              className="w-full border p-3 rounded h-40 font-mono text-xs"
